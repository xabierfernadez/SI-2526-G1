...
### **Título: Puesta en común de la visita al CPD**   
...
- [David Carral -- Xabier -- Nezha](#david-carral----xabier----nezha)
  - [2º Sistemas Microinformáticos y Redes](#2º-sistemas-microinformáticos-y-redes)
    - [**Unidad: 2**](#unidad-2)
    - [**Práctica Nº: 24**](#práctica-nº-24)
    - [**Título: Puesta en común de la visita al CPD**](#título-puesta-en-común-de-la-visita-al-cpd)
    - [**Fecha: 01/12/2025**](#fecha-01122025)
- [Índice](#índice)
  - [Ubicación física de los equipos (¿hay luz directa, humedad, polvo, enchufes sobrecargados, cables sin proteger...?).](#ubicación-física-de-los-equipos-hay-luz-directa-humedad-polvo-enchufes-sobrecargados-cables-sin-proteger)
...
No recibía luz directa, ya que la entrada principal da a un pasillo, y tiene una ventana al otro lado del CPD, pero esta se encontraba cerrada, con la persiana bajada y con un store.

De esa manera, llega una cantidad mínima de luz natural, y esta no es directa.
...
Estaba todo limpio y sin polvo.
...
No había cables fuera del armario (exceptuendo el de alimentación).

El cable de alimentación estaba enchufado sin seguridad ninguna, lo cual hace que cualquiera que entre lo pueda desenchufar sin problemas.

Se podría solucionar pasando el cable por una canaleta y colocando un enchufe con protección (sería un enchufe normal, solo que para poder acceder a el, habría que abrirlo con llave).

<br>
<br>

## Condiciones ambientales: ventilación, temperatura, humedad.

- Ventilación y temperatura

Había un dispositivo de aire acondicionado y un sensor de temperatura en la pared, manteniendo el CPD fresco y a una buena temperatura.
